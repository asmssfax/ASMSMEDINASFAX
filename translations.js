...
const translations = {
  ...
  en: {
    ...
    atrisk_field_photos: "Property Photos",
    atrisk_no_photos: "No photos available for this property yet.",
  ...
  fr: {
    ...
    atrisk_field_photos: "Photos du bien",
    atrisk_no_photos: "Aucune photo disponible pour ce bien pour le moment.",
  ...
  ar: {
    ...
    hero_subtitle: "منصة معلومات جغرافية احترافية لمراقبة المباني التاريخية داخل مدينة صفاقس العتيقة.",
